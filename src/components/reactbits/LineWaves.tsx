...
export default function LineWaves({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line prefer-const -- assigned after the initial resize() call below, which reads it via the `if (program)` guard before it exists
    ...
    function resize() {
      ...
      if (program) {
        (program.uniforms.uResolution as { value: number[] }).value = [
          gl.canvas.width,
          gl.canvas.height,
