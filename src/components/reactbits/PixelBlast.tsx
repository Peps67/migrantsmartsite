...
/**
 * Ported from reactbits.dev (Pixel Blast), MIT + Commons Clause © David Haz
 * — https://github.com/DavidHDev/react-bits. Component inspired by
 * github.com/zavalit/bayer-dithering-webgl-demo.
 * Used here as part of the Migrant Smart site, not redistributed standalone.
 * Kept verbatim: the Bayer-dithered FBM pixel-coverage shader, the touch
 * texture used for the liquid-distortion post-effect, and the
 * reinit-vs-uniform-update lifecycle split. Converted to TS types and a
 * Tailwind className (upstream's CSS file) only.
 */
