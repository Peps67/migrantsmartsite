...
// eslint-disable-next-line @typescript-eslint/no-unused-vars -- unused upstream too; iteration count is uniform-driven (uQuality), not baked into the shader source
