  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background fixed z-50 flex flex-col gap-4 shadow-2xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
          side === "right" &&
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute top-5 right-5 rounded-full p-2 text-foreground/70 opacity-90 transition-opacity hover:opacity-100 hover:bg-accent focus:outline-none">
